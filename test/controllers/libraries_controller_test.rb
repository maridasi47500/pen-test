...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { name: @library.name, programminglanguage_id: @library.programminglanguage_id } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { name: @library.name, programminglanguage_id: @library.programminglanguage_id } }
