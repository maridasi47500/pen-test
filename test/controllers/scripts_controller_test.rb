...
class ScriptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create script" do
    assert_difference('Script.count') do
      post scripts_url, params: { script: { description: @script.description, programminglanguage_id: @script.programminglanguage_id } }
    end
  ...
  test "should update script" do
    patch script_url(@script), params: { script: { description: @script.description, programminglanguage_id: @script.programminglanguage_id } }
