class ScriptsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @script.save
        format.html { redirect_to hack_url(@script.hack), notice: "Script was successfully created." }
  ...
  def update
    respond_to do |format|
      if @script.update(script_params)
        format.html { redirect_to hack_url(@script.hack), notice: "Script was successfully updated." }
  ...
  private
    ...
    def script_params
      params.require(:script).permit(:hack_id,:programminglanguage_id, :description,:library_ids=>[])
    end
end
